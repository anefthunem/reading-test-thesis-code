...
save(factorscores_GPCM_5.22, file = "factorscoresGPCM_5.22.RData")
...
#Save as Object
save(unidim_M2_5.22, file = "M2_results_grade_5_2022.RData")
save(unidim_itemfit_5.22, file = "itemfit_unidim_grade5_2022.RData")
...
#Save factor scores as object
save(factorscores_GPCM_8.22, file = "factorscoresGPCM_8.22.RData")
...
#Save results
save(unidim_M2_8.22, file = "M2_results_grade_8_2022.RData")
save(unidim_itemfit_8.22, file = "itemfit_unidim_grade8_2022.RData")
...
mirtest8Dgrade5.22 <- bfactor(grade5.22, specgrade5.22, bifgrade5.22, itemtype = "gpcm", quadpts = 25, TOL = 1e-4, technical = list(NCYCLES = 20000))
mirtest8Dgrade5.22

#Save as Object
save(mirtest8Dgrade5.22, file = "mirtest8Dgrade5.22.RData")
...
mirtest8Dgrade5.22SE <- bfactor(grade5.22, specgrade5.22, bifgrade5.22, itemtype = "gpcm", quadpts = 25, TOL = 1e-4, 
                                pars = mod2values(mirtest8Dgrade5.22), SE = TRUE, technical = list(NCYCLES = 50000))
mirtest8Dgrade5.22SE

#Save as Object
save(mirtest8Dgrade5.22SE, file = "mirtest8Dgrade5.22SE.RData")
...
#Save as Object
save(factorscores_Bif_5.22, file = "factorscoresBif_5.22.RData")
...
#Save results
save(bif_M2_5.22, file = "M2_2022_bif_results_grade5.RData")
save(bif_itemfit_5.22, file = "itemfit_bifactor_grade5_2022.RData")
...
#Estimate bifactor model with dimension-reduction method with the bfactor() function
mirtest8Dgrade8.22 <- bfactor(grade8.22, specgrade8.22, bifgrade8.22, itemtype = "gpcm", quadpts = 25, TOL = 1e-4, technical = list(NCYCLES = 50000))
mirtest8Dgrade8.22

#Save as Object
save(mirtest8Dgrade8.22, file = "mirtest8Dgrade8.22.RData")

#Estimate bifactor model with standard errors, with starting values from the estimated model above
mirtest8Dgrade8.22SE <- bfactor(grade8.22, specgrade8.22, bifgrade8.22, itemtype = "gpcm", quadpts = 25, TOL = 1e-4, 
                                pars = mod2values(mirtest8Dgrade8.22), SE = TRUE, technical = list(NCYCLES = 50000))
mirtest8Dgrade8.22SE

#Save as Object
save(mirtest8Dgrade8.22SE, file = "mirtest8Dgrade8.22SE.RData")
...
# Save as Object
save(factorscores_Bif_8.22, file = "factorscoresBif_8.22.RData")
...
#Save results
save(bif_M2_8.22, file = "M2_2022_bif_results_grade8.RData")
save(bif_itemfit_8.22, file = "itemfit_bifactor_grade8_2022.RData")
